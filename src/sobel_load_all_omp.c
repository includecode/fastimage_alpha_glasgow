...
//
void sobel_load_all(u8 *cframe, u8 *oframe, f32 threshold)
{
    i32 gx, gy;
    f32 mag = 0.0;
    /*
...
int main(int argc, char **argv)
{
...
#if LOADALLOMP
    sobel_load_all(&cframe[i], oframe, 100.0);
#endif
    ...
    //
    fprintf(stderr, "\n%20llu; %15.3lf; %15.3lf; %15.3lf; %15.3lf; %15.3lf; %15.3lf %% %d;\n",
            (sizeof(u8) * H * W * 3),
            min,
            max,
            avg,
